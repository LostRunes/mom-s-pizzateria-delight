...
const menuData: MenuSection[] = [
  {
    ...
    items: [
      { name: "Classic Margherita Pizza", prices: "₹125 | ₹310" },
      { name: "Corn Cheese Pizza", prices: "₹135 | ₹315" },
      { name: "Farmhouse Pizza", prices: "₹135 | ₹315" },
      { name: "Corn Exotica Pizza", prices: "₹145 | ₹325" },
      { name: "Veggie Lover Pizza", prices: "₹155 | ₹335" },
      { name: "Paneer Pineapple Pizza", prices: "₹155 | ₹335" },
      { name: "Veggie Delight Pizza", prices: "₹155 | ₹335" },
      { name: "Chatpata Paneer Pizza", prices: "₹160 | ₹340" },
      { name: "Paneer Tikka Pizza", prices: "₹160 | ₹340" },
      { name: "Tandoori Paneer Pizza", prices: "₹160 | ₹340" },
      { name: "Mom's Special Veg Pizza", prices: "₹160 | ₹340" },
      { name: "Maharani Veg Overloaded", prices: "₹160 | ₹340" },
    ],
  },
  {
    title: "Non-Veg Pizza",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Crispy Chicken Strips (10 pcs)", prices: "₹249" },
      { name: "Crispy Chicken Strips (15 pcs)", prices: "₹300" },
    ],
  },
  {
